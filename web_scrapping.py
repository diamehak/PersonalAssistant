...
def wikiResult(query):
    try:
        summary = wikipedia.summary(query, sentences=1)  # Get a summary of the topic
        return summary
    except wikipedia.exceptions.DisambiguationError as e:
        return "This query is ambiguous. Please be more specific."
...
def email(rec_email=None, text="Hello, It's LEO here...", sub='LEO'):

...
def createFile(text):
	appLocation = "C:\\Users\\zaara\\OneDrive\\Documents\\mytext.exe"#"C:\\Program Files\\Sublime Text 3\\sublime_text.exe"
	with open(appLocation, 'w') as file:
		file.write(text)
	print(f"File created at: {appLocation}")
